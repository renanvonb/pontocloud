...
export default function Planos() {
  ...
  return (
    <section id="planos" className="pb-12 md:pb-16 lg:pb-16 xl:pb-[88px] bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="reveal rounded-2xl overflow-hidden relative flex items-end min-h-[320px] md:min-h-0 lg:min-h-[440px] xl:min-h-[500px]" style={{ background: 'linear-gradient(to right, #1AAFE8 0%, #0284C7 100%)' }}>
          {/* Left content */}
          <div className="relative z-10 px-6 md:px-8 lg:px-8 xl:px-8 pt-10 md:pt-8 lg:pt-8 xl:pt-10 pb-8 md:pb-8 lg:pb-8 xl:pb-8 flex flex-col justify-between self-stretch w-full lg:w-[calc(32%+32px)]">
            <div className="reveal flex flex-col gap-4">
              <h2 className="text-[20px] xs:text-[26px] md:text-[clamp(34px,_4.4vw,_56px)] leading-[1.05] font-normal tracking-[-0.03em] text-white font-[family-name:var(--font-geist-sans)]">
                <span className="lg:hidden">Valores que<br />cabem no seu bolso</span>
                <span className="hidden lg:inline">Valores<br />que cabem<br />no seu bolso</span>
              </h2>
            ...
            <div className="reveal md:mt-8 lg:mt-0" style={{ transitionDelay: '150ms' }}>
              <Button
          ...
          <div className="reveal-right absolute bottom-0 w-[68%] lg:w-[78%] xl:w-[68%] pointer-events-none hidden lg:block lg:right-[-130px] xl:right-[-40px]" style={{ top: '40px' }}>
